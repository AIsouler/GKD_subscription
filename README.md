...
- **欢迎贡献规则，提交pr前请确认您已仔细阅读 [贡献指南](./CONTRIBUTING.md) 和 [API说明](https://gkd.li/api/)，规则编写可参考 [个人收集的通用规则以及适用场景](./Selectors.md)，让规则写起来更轻松！**
...
- 当前订阅文件已适配 790 个应用，共有 1837 应用规则组，3 全局规则组
...
![img](https://contrib.rocks/image?repo=AIsouler/GKD_subscription&_v=177)
