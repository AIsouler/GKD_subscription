...
首先我们需要给需要添加规则的APP打快照, 也就是把APP的广告截图节点信息给保存下来 <https://i.gkd.li/import/import/12505276> (如何获取这个链接将在审查快照这一步说明)
...
我们就能在电脑上审查 <https://i.gkd.li/import/import/12505286> 这个快照
...
<https://i.gkd.li/import/import/12505350> 鼠标移动到截图里的广告关闭按钮上去点击后查看节点树和属性面板
...
可以看到点击成功了, 但是出现了另外一个弹窗了, 叫你选择关闭原因, 这时我们直接点击网页端的快照按钮得到新快照 <https://i.gkd.li/import/import/12505365>
  ...
  groups: [
    {
      ...
      rules: [
        {
          matches: '[text="关闭当前广告"]',
          snapshotUrls: 'https://i.gkd.li/import/import/12505365',//获取链接的方法在上一步有说明
        },
        {
  ...
  groups: [
    {
      ...
      rules: [
        {
          matches: '[text="关闭当前广告"]',
          snapshotUrls: 'https://i.gkd.li/import/import/12505365',
        },
        {
          matches: '[id$="/nativeclose"]',
          snapshotUrls: [
