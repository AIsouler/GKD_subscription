      ...
      rules: [
        {
          ...
          matches:
            'WebView[text="frs"] > View > View > View > View > TextView[text="签到"]',
          snapshotUrls: [
            'https://i.gkd.li/i/13776801',
            'https://i.gkd.li/i/15087289', // clickable=false
          ],
        },
        {
          key: 1,
          ...
          activityIds: 'com.baidu.tbadk.browser.TBWebContainerActivity',
          matches:
            'WebView[text="签到弹窗"] > View > View > TextView + TextView[text=""]',
          snapshotUrls: [
            'https://i.gkd.li/i/13776424',
            'https://i.gkd.li/i/15087327', // clickable=false
          ],
        },
      ],
    },
