...
export default defineAppConfig({
  ...
  groups: [
    ...
    },
    {
      ...
      quickFind: true,
      activityIds: 'org.qiyi.android.video.MainActivity',
      snapshotUrls: 'https://i.gkd.li/import/import/12495050',
      rules: [
    ...
    },
    {
      ...
      quickFind: true,
      activityIds: 'org.qiyi.android.video.MainActivity',
      snapshotUrls: 'https://i.gkd.li/import/import/12838152',
    ...
    },
    {
      ...
      quickFind: true,
      activityIds: 'org.qiyi.android.video.MainActivity',
      snapshotUrls: 'https://i.gkd.li/import/import/12838158',
