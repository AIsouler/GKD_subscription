      ...
      rules: [
        {
          ...
          snapshotUrls: 'https://i.gkd.li/import/import/12889257',
        },
        {
          matches: '[id="com.dw.btime:id/ad_screen_skip_btn"]',
          snapshotUrls: 'https://i.gkd.li/import/import/12972209',
        },
      ],
    },
    {
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12889448',
    },
    {
      key: 2,
      name: '应用内横幅',
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12889450',
    },
    {
      key: 3,
      name: '更新提示',
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12911011',
    },
  ],
});
