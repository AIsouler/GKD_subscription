  ...
  groups: [
    {
      ...
      snapshotUrls: ['https://i.gkd.li/import/import/12706071'],
    },
    {
      key: 1,
      name: '更新弹窗',
      ...
      snapshotUrls: ['https://i.gkd.li/import/import/12706070'],
    },
    {
      enable: true,
      key: 10,
      ...
      snapshotUrls: ['https://i.gkd.li/import/import/12706065'],
    },
  ],
});
