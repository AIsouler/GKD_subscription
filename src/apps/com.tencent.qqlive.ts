    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          activityIds: '.ona.activity.VideoDetailActivity',
          matches:
            'RecyclerView > RelativeLayout > ComposeView > View > View[clickable=true][childCount=0][visibleToUser=true][index=parent.childCount.minus(1)]',
          exampleUrls: 'https://e.gkd.li/23606b5d-a8e9-4848-9b5a-059e7ecb08af',
          snapshotUrls: 'https://i.gkd.li/i/22870972',
        },
      ],
    },
    {
