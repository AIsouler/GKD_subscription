  ...
  groups: [
    {
      ...
      rules: [
        ...
        },
        {
          ...
          snapshotUrls: 'https://i.gkd.li/import/import/12813235',
        },
        {
          preKeys: [0, 1],
          key: 10,
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          snapshotUrls: [
            'https://i.gkd.li/import/import/12828815', // com.twitter.tweetdetail.TweetDetailActivity
        ...
        },
        {
          ...
          snapshotUrls: [
            'https://i.gkd.li/import/import/12828832', // com.twitter.tweetdetail.TweetDetailActivity
