  ...
  groups: [
    {
      ...
      snapshotUrls: ['https://i.gkd.li/import/import/12705347'],
    },
    {
      key: 1,
      name: '更新弹窗',
      ...
      snapshotUrls: ['https://i.gkd.li/import/import/12705351'],
    },
    {
      key: 2,
      name: '信息流、文章底部广告',
      ...
      rules: [
        {
          ...
          snapshotUrls: [
            'https://i.gkd.li/import/import/12705353', // activityId: 'com.seebaby.login.ui.activity.LauncherActivity'
            'https://i.gkd.li/import/import/12705363', // activityIds: 'com.seebaby.parent.article.ui.activity.NativeArticleDetailActivity'
          ],
        },
        {
          key: 2,
          ...
          snapshotUrls: ['https://i.gkd.li/import/import/12705372'],
        },
        {
          preKeys: [1, 2],
          key: 3,
          matches: '[id="com.seebaby:id/tv_un_instrest"]',
          snapshotUrls: ['https://i.gkd.li/import/import/12705358'],
        },
      ],
    },
  ],
