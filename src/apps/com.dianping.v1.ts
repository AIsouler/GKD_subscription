  ...
  groups: [
    {
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12726928', // 对应第二条activityIds
    ...
    },
    {
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12727011',
    },
    {
      key: 2,
      name: '消息页上方开启系统通知提醒',
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12727070',
    },
    {
      key: 3,
      name: '关闭[签到开红包]',
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12727366',
    },
  ],
});
