  ...
  groups: [
    {
      ...
      snapshotUrls: ['https://gkd-kit.gitee.io/import/12647186'],
    },
    {
      key: 1,
      name: '更新弹窗',
    ...
    },
    {
      ...
      snapshotUrls: ['https://gkd-kit.gitee.io/import/12647000'],
    },
    {
      key: 3,
      name: '右侧悬浮广告',
      rules: [
        {
          ...
          snapshotUrls: [
            'https://gkd-kit.gitee.io/import/12647039', // 信用卡页面
            'https://gkd-kit.gitee.io/import/12647052', // 我的页面
          ],
        },
        {
          desc: '查账页面-悬浮广告',
          ...
          snapshotUrls: ['https://gkd-kit.gitee.io/import/12647127'],
        },
      ],
    },
    {
      ...
      snapshotUrls: ['https://gkd-kit.gitee.io/import/12647068'],
    },
  ],
});
