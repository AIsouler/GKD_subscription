      ...
      rules: [
        {
          ...
          anyMatches: [
            ...
            '@[clickable=true] - [text*="跳过"][text.length<10][width<400 && height<200][visibleToUser=true]', // https://github.com/AIsouler/GKD_subscription/issues/1024
          ],
          snapshotUrls: [
        ...
        },
        {
          key: 1,
          excludeMatches: [
            '@[clickable=true] - [text*="跳过"][text.length<10][width<400 && height<200][visibleToUser=true]',
            '@[clickable=true][visibleToUser=true] + ViewGroup > [text="跳过"]',
          ],
          matches:
