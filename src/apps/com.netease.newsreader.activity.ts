  ...
  groups: [
    {
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12639864',
    },
    {
      key: 1,
      name: '版本更新弹窗',
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12639884',
    },
    {
      key: 2,
      name: '系统推送弹窗',
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12639800',
    },
    {
      key: 3,
      name: '系统推送提示信息',
      ...
      snapshotUrls: 'https://i.gkd.li/import/import/12639869',
    },
    {
      enable: false,
      key: 4,
      ...
      rules: [
        {
          ...
          name: '首页信息流广告-反馈理由',
          matches: '[text="不感兴趣"]',
          snapshotUrls: 'https://i.gkd.li/import/import/12639752',
        },
        {
          key: 1,
          matches:
            'FrameLayout[childCount=1] >5 TextView[text="广告"] +2 ImageView[clickable=true]',
          snapshotUrls: 'https://i.gkd.li/import/import/12639751',
        },
      ],
    },
  ],
