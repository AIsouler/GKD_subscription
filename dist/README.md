...
|华为应用市场|6|<li>开屏广告<li>更新提示<li>功能类-应用更新页面-点击[查看更多]<li>全屏广告-热门应用推荐弹窗<li>局部广告-卡片广告<li>权限提示-通知权限|
|华为阅读|1|<li>开屏广告|
...
|稀饭动漫|1|<li>全屏广告-弹窗广告|
|稀土掘金|1|<li>更新提示|
|喜马拉雅|13|<li>开屏广告<li>局部广告-首页右侧浮动广告<li>局部广告-播放页面-播放控制区域的广告<li>分段广告-播放页面-底部推荐列表-夹杂广告<li>局部广告-播放页面-播放前广告<li>分段广告-信息流广告<li>局部广告-热播推荐广告<li>青少年模式<li>局部广告-评论区广告<li>全屏广告-首页-专辑订阅推荐弹窗<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>全屏广告-免流提示|
