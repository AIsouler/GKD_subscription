...
|123云盘|4|<li>开屏广告<li>全屏广告-弹窗广告<li>更新提示<li>更新提示-WEB端版本更新提示|
...
|腾讯会议|1|<li>更新提示|
|腾讯视频|7|<li>开屏广告<li>青少年模式<li>更新提示<li>分段广告-卡片广告<li>全屏广告-视频播放时的广告<li>全屏广告-首页-弹窗广告<li>权限提示-通知权限|
...
|下载管理|1|<li>更新提示|
|闲鱼|8|<li>权限提示-通知权限<li>权限提示<li>更新提示<li>全屏广告-红包弹窗<li>分段广告-搜索结果页广告<li>功能类-自动点击[查看原图]<li>功能类-闲鱼币任务——功能测试<li>功能类-背包使用道具——功能测试|
...
|中国联通|5|<li>开屏广告<li>权限提示<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-首页右下角卡片悬浮窗|
