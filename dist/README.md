...
|百度输入法定制版|1|<li>开屏广告|
|百度贴吧|13|<li>开屏广告<li>权限提示-通知权限<li>分段广告-信息流广告<li>局部广告-首页、推荐列表顶部卡片广告<li>更新提示<li>全屏广告-弹窗广告<li>局部广告-悬浮小广告<li>局部广告-[帖子内/吧内]底部悬浮窗<li>功能类-贴吧内签到并关闭弹窗<li>局部广告-帖子底部话题卡片<li>全屏广告-会员弹窗<li>局部广告-信息流广告<li>局部广告-帖子推广|
