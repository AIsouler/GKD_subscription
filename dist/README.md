...
|华为主题|9|<li>开屏广告<li>局部广告-主题详情页“下应用领主题”横幅<li>分段广告-主题详情页广告<li>分段广告-主题详情信息流广告<li>局部广告-分类页“免费领取”<li>分段广告-主页面（推荐、分类、我的）广告<li>全屏广告-首页活动弹窗<li>更新提示<li>权限提示-通知权限|
|欢律|1|<li>更新提示|
|会计云课堂|1|<li>开屏广告|
|集换社|1|<li>开屏广告|
...
|米游社|6|<li>青少年模式<li>更新提示<li>功能类-自动打卡<li>功能类-原神自动签到<li>功能类-星穹铁道自动签到<li>全屏广告-游戏版本活动|
...
|三星阅读|1|<li>开屏广告|
|扫描全能王|2|<li>局部广告-主页面上方广告<li>开屏广告-免费试用|
|森空岛|1|<li>青少年模式|
