...
|豆瓣|10|<li>开屏广告<li>功能类-不分享/同步作品短评<li>分段广告-剧照广告<li>分段广告-信息流广告<li>分段广告-卡片广告<li>评价提示-关闭评分反馈弹窗<li>分段广告-搜索页/帖子内容与评论区中间的卡片广告<li>局部广告-个性化内容推荐弹窗<li>全屏广告-弹窗广告<li>更新提示|
|毒霸姬|1|<li>更新提示|
...
|中国人保|1|<li>更新提示|
|中国移动|7|<li>开屏广告<li>更新提示<li>全屏广告-首页弹窗广告<li>权限提示-通知权限<li>权限提示-请求获取剪贴板权限弹窗<li>局部广告-右侧悬浮小图标<li>评价提示-请求好评弹窗|
