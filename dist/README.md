...
|虎扑|1|<li>分段广告-信息流广告|
|虎牙直播|4|<li>局部广告-直播间悬浮广告<li>更新提示<li>全屏广告-弹窗广告<li>功能类-root提示|
|花瓣|1|<li>更新提示-版本更新弹窗|
|花瓣测速|1|<li>更新提示|
...
|米游社|5|<li>更新提示<li>功能类-自动打卡<li>全屏广告-游戏版本活动<li>分段广告-游戏版本活动<li>功能类-米游自动签到全家桶|
