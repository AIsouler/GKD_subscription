...
|菜鸟|10|<li>全屏广告-弹窗广告<li>局部广告-包裹页面-地图底部横条广告<li>更新提示<li>权限提示-通知权限<li>评价提示<li>全屏广告-今日手气红包<li>全屏广告-发现页新装试用弹窗<li>功能类-询问[是否要查询包裹]弹窗<li>功能类-包裹页面-自动展开更多物流信息<li>局部广告-包裹页面-物流信息底部横条广告|
|畅听FM|1|<li>全屏广告-弹窗广告|
