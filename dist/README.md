...
|起点读书|14|<li>开屏广告<li>更新提示<li>青少年模式<li>全屏广告<li>权限提示-通知权限<li>局部广告-悬浮广告<li>功能类-起点中文网登录自动确认<li>局部广告-信息流广告<li>其他-福利中心看视频后获得奖励<li>全屏广告-红包弹窗<li>功能类-移动网络下自动点击播放视频<li>功能类-自动签到<li>功能类-做任务点击[去完成]<li>功能类-获得积分点击[知道了]|
