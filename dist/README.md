...
|饿了么|10|<li>更新提示<li>全屏广告-红包弹窗<li>全屏广告-活动弹窗<li>全屏广告-付款后弹窗广告<li>全屏广告-吃货卡续费弹窗<li>局部广告-首页底部浮窗广告<li>权限提示-定位权限<li>通知提示-获取订单信息通知<li>评价提示-底部调研邀请卡片<li>功能类-下单后自动领取吃货豆|
|鄂汇办|1|<li>开屏广告|
|儿歌多多|1|<li>局部广告-卡片广告|
