...
|米游社|7|<li>青少年模式<li>更新提示<li>功能类-自动打卡<li>功能类-原神自动签到<li>功能类-星穹铁道自动签到<li>全屏广告-游戏版本活动<li>分段广告-游戏版本活动|
...
|应用包管理组件|6|<li>功能类-放弃开启安全守护<li>功能类-安装来源不可信<li>功能类-自动第三方安装应用<li>功能类-自动安装应用<li>功能类-自动更新应用<li>功能类-澎湃-自动安装/更新|
|应用宝|1|<li>功能类-关闭登录弹窗|
|应用汇|1|<li>全屏广告-弹窗广告|
